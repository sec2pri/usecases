...
```{r}
if(!file.exists("dataInput/HGNCMappings.txt")){
  #download.file('https://reactome.org/download/current/UniProt2Reactome_PE_Pathway.txt', destfile=paste0(workingDirectory, '/dataInput/UniProt2Reactome.txt'), method = "wget", extra = "-r -p --random-wait") ##Update with latest file!
}
```
